# Claude Desktop Pro Instructions: sharing-skills
...
2. **Activation:**
   ```
   "Use sharing-skills skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/sharing-skills.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `sharing-skills.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the sharing-skills skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the sharing-skills checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all sharing-skills requirements are met"
   ```
...
Claude: "I'm using the sharing-skills skill to approach this systematically.
...
```
"Use brainstorming to design, then sharing-skills to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/sharing-skills.zip`

**Contents:**
- Main skill file: `sharing-skills.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for sharing-skills steps"
   ```
...
- Try: "Check your capabilities for sharing-skills"
...
- **Source:** `superpowers-desktop/pro-setup/skills/meta/sharing-skills.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/sharing-skills.zip`
