# Claude Desktop Pro Instructions: writing-skills
...
2. **Activation:**
   ```
   "Use writing-skills skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/writing-skills.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `writing-skills.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the writing-skills skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the writing-skills checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all writing-skills requirements are met"
   ```
...
Claude: "I'm using the writing-skills skill to approach this systematically.
...
```
"Use brainstorming to design, then writing-skills to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/writing-skills.zip`

**Contents:**
- Main skill file: `writing-skills.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for writing-skills steps"
   ```
...
- Try: "Check your capabilities for writing-skills"
...
- **Source:** `superpowers-desktop/pro-setup/skills/meta/writing-skills.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/writing-skills.zip`
