# Claude Desktop Pro Instructions: testing-skills-with-subagents
...
2. **Activation:**
   ```
   "Use testing-skills-with-subagents skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/testing-skills-with-subagents.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `testing-skills-with-subagents.md` to project knowledge
...
- testing-skills-with-subagents (meta)
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the testing-skills-with-subagents skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the testing-skills-with-subagents checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all testing-skills-with-subagents requirements are met"
   ```
...
Claude: "I'm using the testing-skills-with-subagents skill to approach this systematically.
...
```
"Use brainstorming to design, then testing-skills-with-subagents to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/testing-skills-with-subagents.zip`

**Contents:**
- Main skill file: `testing-skills-with-subagents.md`
...
3. Upload `testing-skills-with-subagents.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for testing-skills-with-subagents steps"
   ```
...
- Try: "Check your capabilities for testing-skills-with-subagents"
...
- **Source:** `superpowers-desktop/pro-setup/skills/meta/testing-skills-with-subagents.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/testing-skills-with-subagents.zip`
