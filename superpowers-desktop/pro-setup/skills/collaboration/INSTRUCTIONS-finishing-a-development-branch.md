# Claude Desktop Pro Instructions: finishing-a-development-branch
...
3. **Two Upload Methods:**
   ...
   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/finishing-a-development-branch.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `finishing-a-development-branch.md` to project knowledge
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the finishing-a-development-branch checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all finishing-a-development-branch requirements are met"
   ```
...
Claude: "I'm using the finishing-a-development-branch skill to approach this systematically.
...
```
"Use brainstorming to design, then finishing-a-development-branch to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/finishing-a-development-branch.zip`

**Contents:**
- Main skill file: `finishing-a-development-branch.md`
...
3. Upload `finishing-a-development-branch.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for finishing-a-development-branch steps"
   ```
...
- Try: "Check your capabilities for finishing-a-development-branch"
...
- **Source:** `superpowers-desktop/pro-setup/skills/collaboration/finishing-a-development-branch.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/finishing-a-development-branch.zip`
