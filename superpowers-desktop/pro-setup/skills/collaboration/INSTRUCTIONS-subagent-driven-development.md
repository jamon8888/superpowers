# Claude Desktop Pro Instructions: subagent-driven-development
...
2. **Activation:**
   ```
   "Use subagent-driven-development skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/subagent-driven-development.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `subagent-driven-development.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the subagent-driven-development skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the subagent-driven-development checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all subagent-driven-development requirements are met"
   ```
...
Claude: "I'm using the subagent-driven-development skill to approach this systematically.
...
```
"Use brainstorming to design, then subagent-driven-development to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/subagent-driven-development.zip`

**Contents:**
- Main skill file: `subagent-driven-development.md`
...
3. Upload `subagent-driven-development.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for subagent-driven-development steps"
   ```
...
- Try: "Check your capabilities for subagent-driven-development"
...
- **Source:** `superpowers-desktop/pro-setup/skills/collaboration/subagent-driven-development.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/subagent-driven-development.zip`
