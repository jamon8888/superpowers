# Claude Desktop Pro Instructions: receiving-code-review
...
2. **Activation:**
   ```
   "Use receiving-code-review skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/receiving-code-review.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `receiving-code-review.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the receiving-code-review skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the receiving-code-review checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all receiving-code-review requirements are met"
   ```
...
Claude: "I'm using the receiving-code-review skill to approach this systematically.
...
```
"Use brainstorming to design, then receiving-code-review to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/receiving-code-review.zip`

**Contents:**
- Main skill file: `receiving-code-review.md`
...
3. Upload `receiving-code-review.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for receiving-code-review steps"
   ```
...
- Try: "Check your capabilities for receiving-code-review"
...
- **Source:** `superpowers-desktop/pro-setup/skills/collaboration/receiving-code-review.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/receiving-code-review.zip`
