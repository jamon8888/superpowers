# Claude Desktop Pro Instructions: writing-plans
...
2. **Activation:**
   ```
   "Use writing-plans skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/writing-plans.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `writing-plans.md` to project knowledge
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the writing-plans checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all writing-plans requirements are met"
   ```
...
Claude: "I'm using the writing-plans skill to approach this systematically.
...
```
"Use brainstorming to design, then writing-plans to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/writing-plans.zip`

**Contents:**
- Main skill file: `writing-plans.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for writing-plans steps"
   ```
...
- Try: "Check your capabilities for writing-plans"
...
- **Source:** `superpowers-desktop/pro-setup/skills/collaboration/writing-plans.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/writing-plans.zip`
