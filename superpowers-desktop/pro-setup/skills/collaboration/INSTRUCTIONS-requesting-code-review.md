# Claude Desktop Pro Instructions: requesting-code-review
...
2. **Activation:**
   ```
   "Use requesting-code-review skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/requesting-code-review.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `requesting-code-review.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the requesting-code-review skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the requesting-code-review checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all requesting-code-review requirements are met"
   ```
...
Claude: "I'm using the requesting-code-review skill to approach this systematically.
...
```
"Use brainstorming to design, then requesting-code-review to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/requesting-code-review.zip`

**Contents:**
- Main skill file: `requesting-code-review.md`
...
3. Upload `requesting-code-review.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for requesting-code-review steps"
   ```
...
- Try: "Check your capabilities for requesting-code-review"
...
- **Source:** `superpowers-desktop/pro-setup/skills/collaboration/requesting-code-review.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/requesting-code-review.zip`
