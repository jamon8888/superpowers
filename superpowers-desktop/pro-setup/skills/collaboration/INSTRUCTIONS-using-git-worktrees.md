# Claude Desktop Pro Instructions: using-git-worktrees
...
2. **Activation:**
   ```
   "Use using-git-worktrees skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/using-git-worktrees.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `using-git-worktrees.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the using-git-worktrees skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the using-git-worktrees checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all using-git-worktrees requirements are met"
   ```
...
Claude: "I'm using the using-git-worktrees skill to approach this systematically.
...
```
"Use brainstorming to design, then using-git-worktrees to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/using-git-worktrees.zip`

**Contents:**
- Main skill file: `using-git-worktrees.md`
...
3. Upload `using-git-worktrees.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for using-git-worktrees steps"
   ```
...
- Try: "Check your capabilities for using-git-worktrees"
...
- **Source:** `superpowers-desktop/pro-setup/skills/collaboration/using-git-worktrees.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/using-git-worktrees.zip`
