# Claude Desktop Pro Instructions: executing-plans
...
2. **Activation:**
   ```
   "Use executing-plans skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/executing-plans.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `executing-plans.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the executing-plans skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the executing-plans checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all executing-plans requirements are met"
   ```
...
Claude: "I'm using the executing-plans skill to approach this systematically.
...
```
"Use brainstorming to design, then executing-plans to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/executing-plans.zip`

**Contents:**
- Main skill file: `executing-plans.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for executing-plans steps"
   ```
...
- Try: "Check your capabilities for executing-plans"
...
- **Source:** `superpowers-desktop/pro-setup/skills/collaboration/executing-plans.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/executing-plans.zip`
