# Claude Desktop Pro Instructions: linkedin-formats
...
2. **Activation:**
   ```
   "Use linkedin-formats skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/linkedin-formats.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `linkedin-formats.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the linkedin-formats skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the linkedin-formats checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all linkedin-formats requirements are met"
   ```
...
Claude: "I'm using the linkedin-formats skill to approach this systematically.
...
```
"Use brainstorming to design, then linkedin-formats to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/linkedin-formats.zip`

**Contents:**
- Main skill file: `linkedin-formats.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for linkedin-formats steps"
   ```
...
- Try: "Check your capabilities for linkedin-formats"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/linkedin-formats.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/linkedin-formats.zip`
