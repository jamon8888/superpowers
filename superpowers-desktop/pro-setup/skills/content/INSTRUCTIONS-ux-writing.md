# Claude Desktop Pro Instructions: ux-writing
...
2. **Activation:**
   ```
   "Use ux-writing skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/ux-writing.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `ux-writing.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the ux-writing skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the ux-writing checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all ux-writing requirements are met"
   ```
...
Claude: "I'm using the ux-writing skill to approach this systematically.
...
```
"Use brainstorming to design, then ux-writing to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/ux-writing.zip`

**Contents:**
- Main skill file: `ux-writing.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for ux-writing steps"
   ```
...
- Try: "Check your capabilities for ux-writing"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/ux-writing.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/ux-writing.zip`
