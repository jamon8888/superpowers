# Claude Desktop Pro Instructions: thought-leadership-angles
...
2. **Activation:**
   ```
   "Use thought-leadership-angles skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/thought-leadership-angles.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `thought-leadership-angles.md` to project knowledge
...
- thought-leadership-angles (content)
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the thought-leadership-angles skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the thought-leadership-angles checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all thought-leadership-angles requirements are met"
   ```
...
Claude: "I'm using the thought-leadership-angles skill to approach this systematically.
...
```
"Use brainstorming to design, then thought-leadership-angles to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/thought-leadership-angles.zip`

**Contents:**
- Main skill file: `thought-leadership-angles.md`
...
3. Upload `thought-leadership-angles.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for thought-leadership-angles steps"
   ```
...
- Try: "Check your capabilities for thought-leadership-angles"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/thought-leadership-angles.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/thought-leadership-angles.zip`
