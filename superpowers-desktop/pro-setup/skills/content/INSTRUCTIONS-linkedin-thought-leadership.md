# Claude Desktop Pro Instructions: linkedin-thought-leadership
...
2. **Activation:**
   ```
   "Use linkedin-thought-leadership skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/linkedin-thought-leadership.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `linkedin-thought-leadership.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the linkedin-thought-leadership skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the linkedin-thought-leadership checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all linkedin-thought-leadership requirements are met"
   ```
...
Claude: "I'm using the linkedin-thought-leadership skill to approach this systematically.
...
```
"Use brainstorming to design, then linkedin-thought-leadership to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/linkedin-thought-leadership.zip`

**Contents:**
- Main skill file: `linkedin-thought-leadership.md`
...
3. Upload `linkedin-thought-leadership.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for linkedin-thought-leadership steps"
   ```
...
- Try: "Check your capabilities for linkedin-thought-leadership"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/linkedin-thought-leadership.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/linkedin-thought-leadership.zip`
