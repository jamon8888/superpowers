# Claude Desktop Pro Instructions: accessibility-guidelines
...
3. **Two Upload Methods:**
   ...
   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/accessibility-guidelines.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `accessibility-guidelines.md` to project knowledge
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the accessibility-guidelines checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all accessibility-guidelines requirements are met"
   ```
...
Claude: "I'm using the accessibility-guidelines skill to approach this systematically.
...
```
"Use brainstorming to design, then accessibility-guidelines to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/accessibility-guidelines.zip`

**Contents:**
- Main skill file: `accessibility-guidelines.md`
...
3. Upload `accessibility-guidelines.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for accessibility-guidelines steps"
   ```
...
- Try: "Check your capabilities for accessibility-guidelines"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/accessibility-guidelines.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/accessibility-guidelines.zip`
