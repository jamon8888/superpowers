# Claude Desktop Pro Instructions: voice-chart-template
...
2. **Activation:**
   ```
   "Use voice-chart-template skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/voice-chart-template.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `voice-chart-template.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the voice-chart-template skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the voice-chart-template checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all voice-chart-template requirements are met"
   ```
...
Claude: "I'm using the voice-chart-template skill to approach this systematically.
...
```
"Use brainstorming to design, then voice-chart-template to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/voice-chart-template.zip`

**Contents:**
- Main skill file: `voice-chart-template.md`
...
3. Upload `voice-chart-template.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for voice-chart-template steps"
   ```
...
- Try: "Check your capabilities for voice-chart-template"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/voice-chart-template.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/voice-chart-template.zip`
