# Claude Desktop Pro Instructions: patterns-detailed
...
2. **Activation:**
   ```
   "Use patterns-detailed skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/patterns-detailed.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `patterns-detailed.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the patterns-detailed skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the patterns-detailed checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all patterns-detailed requirements are met"
   ```
...
Claude: "I'm using the patterns-detailed skill to approach this systematically.
...
```
"Use brainstorming to design, then patterns-detailed to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/patterns-detailed.zip`

**Contents:**
- Main skill file: `patterns-detailed.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for patterns-detailed steps"
   ```
...
- Try: "Check your capabilities for patterns-detailed"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/patterns-detailed.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/patterns-detailed.zip`
