# Claude Desktop Pro Instructions: engagement-frameworks
...
2. **Activation:**
   ```
   "Use engagement-frameworks skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/engagement-frameworks.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `engagement-frameworks.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the engagement-frameworks skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the engagement-frameworks checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all engagement-frameworks requirements are met"
   ```
...
Claude: "I'm using the engagement-frameworks skill to approach this systematically.
...
```
"Use brainstorming to design, then engagement-frameworks to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/engagement-frameworks.zip`

**Contents:**
- Main skill file: `engagement-frameworks.md`
...
3. Upload `engagement-frameworks.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for engagement-frameworks steps"
   ```
...
- Try: "Check your capabilities for engagement-frameworks"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/engagement-frameworks.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/engagement-frameworks.zip`
