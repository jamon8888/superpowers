# Claude Desktop Pro Instructions: error-message-template
...
2. **Activation:**
   ```
   "Use error-message-template skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/error-message-template.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `error-message-template.md` to project knowledge
...
- error-message-template (content)
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the error-message-template skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the error-message-template checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all error-message-template requirements are met"
   ```
...
Claude: "I'm using the error-message-template skill to approach this systematically.
...
```
"Use brainstorming to design, then error-message-template to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/error-message-template.zip`

**Contents:**
- Main skill file: `error-message-template.md`
...
3. Upload `error-message-template.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for error-message-template steps"
   ```
...
- Try: "Check your capabilities for error-message-template"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/error-message-template.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/error-message-template.zip`
