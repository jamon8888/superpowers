# Claude Desktop Pro Instructions: humanisation-texte-ia-francais
...
2. **Activation:**
   ```
   "Use humanisation-texte-ia-francais skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/humanisation-texte-ia-francais.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `humanisation-texte-ia-francais.md` to project knowledge
...
- humanisation-texte-ia-francais (content)
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the humanisation-texte-ia-francais skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the humanisation-texte-ia-francais checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all humanisation-texte-ia-francais requirements are met"
   ```
...
Claude: "I'm using the humanisation-texte-ia-francais skill to approach this systematically.
...
```
"Use brainstorming to design, then humanisation-texte-ia-francais to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/humanisation-texte-ia-francais.zip`

**Contents:**
- Main skill file: `humanisation-texte-ia-francais.md`
...
3. Upload `humanisation-texte-ia-francais.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for humanisation-texte-ia-francais steps"
   ```
...
- Try: "Check your capabilities for humanisation-texte-ia-francais"
...
- **Source:** `superpowers-desktop/pro-setup/skills/content/humanisation-texte-ia-francais.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/humanisation-texte-ia-francais.zip`
