# Claude Desktop Pro Instructions: testing-anti-patterns
...
2. **Activation:**
   ```
   "Use testing-anti-patterns skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/testing-anti-patterns.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `testing-anti-patterns.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the testing-anti-patterns skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the testing-anti-patterns checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all testing-anti-patterns requirements are met"
   ```
...
Claude: "I'm using the testing-anti-patterns skill to approach this systematically.
...
```
"Use brainstorming to design, then testing-anti-patterns to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/testing-anti-patterns.zip`

**Contents:**
- Main skill file: `testing-anti-patterns.md`
...
3. Upload `testing-anti-patterns.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for testing-anti-patterns steps"
   ```
...
- Try: "Check your capabilities for testing-anti-patterns"
...
- **Source:** `superpowers-desktop/pro-setup/skills/testing/testing-anti-patterns.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/testing-anti-patterns.zip`
