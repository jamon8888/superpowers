# Claude Desktop Pro Instructions: condition-based-waiting
...
2. **Activation:**
   ```
   "Use condition-based-waiting skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/condition-based-waiting.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `condition-based-waiting.md` to project knowledge
...
- condition-based-waiting (testing)
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the condition-based-waiting skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the condition-based-waiting checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all condition-based-waiting requirements are met"
   ```
...
Claude: "I'm using the condition-based-waiting skill to approach this systematically.
...
```
"Use brainstorming to design, then condition-based-waiting to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/condition-based-waiting.zip`

**Contents:**
- Main skill file: `condition-based-waiting.md`
...
3. Upload `condition-based-waiting.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for condition-based-waiting steps"
   ```
...
- Try: "Check your capabilities for condition-based-waiting"
...
- **Source:** `superpowers-desktop/pro-setup/skills/testing/condition-based-waiting.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/condition-based-waiting.zip`
