# Claude Desktop Pro Instructions: systematic-debugging
...
2. **Activation:**
   ```
   "Use systematic-debugging skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/systematic-debugging.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `systematic-debugging.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the systematic-debugging skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the systematic-debugging checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all systematic-debugging requirements are met"
   ```
...
Claude: "I'm using the systematic-debugging skill to approach this systematically.
...
```
"Use brainstorming to design, then systematic-debugging to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/systematic-debugging.zip`

**Contents:**
- Main skill file: `systematic-debugging.md`
...
3. Upload `systematic-debugging.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for systematic-debugging steps"
   ```
...
- Try: "Check your capabilities for systematic-debugging"
...
- **Source:** `superpowers-desktop/pro-setup/skills/core/systematic-debugging.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/systematic-debugging.zip`
