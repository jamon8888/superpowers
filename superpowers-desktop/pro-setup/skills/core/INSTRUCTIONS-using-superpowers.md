# Claude Desktop Pro Instructions: using-superpowers
...
2. **Activation:**
   ```
   "Use using-superpowers skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/using-superpowers.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `using-superpowers.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the using-superpowers skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the using-superpowers checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all using-superpowers requirements are met"
   ```
...
Claude: "I'm using the using-superpowers skill to approach this systematically.
...
```
"Use brainstorming to design, then using-superpowers to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/using-superpowers.zip`

**Contents:**
- Main skill file: `using-superpowers.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for using-superpowers steps"
   ```
...
- Try: "Check your capabilities for using-superpowers"
...
- **Source:** `superpowers-desktop/pro-setup/skills/core/using-superpowers.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/using-superpowers.zip`
