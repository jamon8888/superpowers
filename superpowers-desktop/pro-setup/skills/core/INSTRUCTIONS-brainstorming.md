# Claude Desktop Pro Instructions: brainstorming
...
2. **Activation:**
   ```
   "Use brainstorming skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/brainstorming.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `brainstorming.md` to project knowledge
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the brainstorming checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all brainstorming requirements are met"
   ```
...
Claude: "I'm using the brainstorming skill to approach this systematically.
...
```
"Use brainstorming to design, then brainstorming to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/brainstorming.zip`

**Contents:**
- Main skill file: `brainstorming.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for brainstorming steps"
   ```
...
- Try: "Check your capabilities for brainstorming"
...
- **Source:** `superpowers-desktop/pro-setup/skills/core/brainstorming.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/brainstorming.zip`
