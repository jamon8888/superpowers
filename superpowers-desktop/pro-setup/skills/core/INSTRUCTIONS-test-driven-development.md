# Claude Desktop Pro Instructions: test-driven-development
...
2. **Activation:**
   ```
   "Use test-driven-development skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/test-driven-development.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `test-driven-development.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the test-driven-development skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the test-driven-development checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all test-driven-development requirements are met"
   ```
...
Claude: "I'm using the test-driven-development skill to approach this systematically.
...
**Location:** `superpowers-desktop/pro-setup/skill-zips/test-driven-development.zip`

**Contents:**
- Main skill file: `test-driven-development.md`
...
3. Upload `test-driven-development.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for test-driven-development steps"
   ```
...
- Try: "Check your capabilities for test-driven-development"
...
- **Source:** `superpowers-desktop/pro-setup/skills/core/test-driven-development.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/test-driven-development.zip`
