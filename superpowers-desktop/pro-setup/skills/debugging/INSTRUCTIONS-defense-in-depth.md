# Claude Desktop Pro Instructions: defense-in-depth
...
2. **Activation:**
   ```
   "Use defense-in-depth skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/defense-in-depth.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `defense-in-depth.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the defense-in-depth skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the defense-in-depth checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all defense-in-depth requirements are met"
   ```
...
Claude: "I'm using the defense-in-depth skill to approach this systematically.
...
```
"Use brainstorming to design, then defense-in-depth to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/defense-in-depth.zip`

**Contents:**
- Main skill file: `defense-in-depth.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for defense-in-depth steps"
   ```
...
- Try: "Check your capabilities for defense-in-depth"
...
- **Source:** `superpowers-desktop/pro-setup/skills/debugging/defense-in-depth.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/defense-in-depth.zip`
