# Claude Desktop Pro Instructions: root-cause-tracing
...
2. **Activation:**
   ```
   "Use root-cause-tracing skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/root-cause-tracing.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `root-cause-tracing.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the root-cause-tracing skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the root-cause-tracing checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all root-cause-tracing requirements are met"
   ```
...
Claude: "I'm using the root-cause-tracing skill to approach this systematically.
...
```
"Use brainstorming to design, then root-cause-tracing to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/root-cause-tracing.zip`

**Contents:**
- Main skill file: `root-cause-tracing.md`
...
3. Upload `root-cause-tracing.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for root-cause-tracing steps"
   ```
...
- Try: "Check your capabilities for root-cause-tracing"
...
- **Source:** `superpowers-desktop/pro-setup/skills/debugging/root-cause-tracing.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/root-cause-tracing.zip`
