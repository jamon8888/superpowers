# Claude Desktop Pro Instructions: verification-before-completion
...
2. **Activation:**
   ```
   "Use verification-before-completion skill to help me with..."
   ```

3. **Two Upload Methods:**

   **Method A: ZIP Upload (Recommended)**
   - Pre-built ZIP available in `skill-zips/verification-before-completion.zip`
   ...
   **Method B: Project Knowledge**
   ...
   - Upload `verification-before-completion.md` to project knowledge
...
1. **Explicit Invocation:**
   ...
   ```
   "Use the verification-before-completion skill for this task"
   ```
...
3. **Manual Tracking (without TodoWrite):**
   ...
   ```
   "Track the verification-before-completion checklist as we go"
   ```

4. **Verification:**
   ```
   "Verify all verification-before-completion requirements are met"
   ```
...
Claude: "I'm using the verification-before-completion skill to approach this systematically.
...
```
"Use brainstorming to design, then verification-before-completion to implement"
```

### ZIP Upload Details

**Location:** `superpowers-desktop/pro-setup/skill-zips/verification-before-completion.zip`

**Contents:**
- Main skill file: `verification-before-completion.md`
...
3. Upload `verification-before-completion.md`
...
1. **Use TodoWrite for tracking:**
   ```
   "Create a TodoWrite checklist for verification-before-completion steps"
   ```
...
- Try: "Check your capabilities for verification-before-completion"
...
- **Source:** `superpowers-desktop/pro-setup/skills/debugging/verification-before-completion.md`
- **ZIP:** `superpowers-desktop/pro-setup/skill-zips/verification-before-completion.zip`
