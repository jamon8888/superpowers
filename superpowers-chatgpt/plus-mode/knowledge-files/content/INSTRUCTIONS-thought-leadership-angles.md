# ChatGPT Pro Instructions: thought-leadership-angles
...
2. **Manual Tracking:**
   ...
   ```
   "Track the checklist from thought-leadership-angles in your response"
   ```

3. **Verification:**
   After each phase:
   ```
   "Verify that we've completed all thought-leadership-angles requirements"
   ```
...
You: "I'm going to use the thought-leadership-angles skill to approach this systematically.
...
```
"Use brainstorming skill to design this, then thought-leadership-angles to implement"
```
...
1. **Start conversations with skill invocation:**
   ```
   "Let's use thought-leadership-angles for this task"
   ```
...
3. **Verify completion:**
   ```
   "Did we follow all thought-leadership-angles requirements?"
   ```

4. **Reference project knowledge:**
   ```
   "Check thought-leadership-angles.md for the exact steps"
   ```
...
- Try: "Check your knowledge files for thought-leadership-angles"
...
- **Source:** `superpowers-chatgpt/plus-mode/knowledge-files/content/thought-leadership-angles.md`
