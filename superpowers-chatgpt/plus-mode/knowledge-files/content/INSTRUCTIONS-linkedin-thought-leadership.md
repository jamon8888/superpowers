# ChatGPT Pro Instructions: linkedin-thought-leadership
...
2. **Manual Tracking:**
   ...
   ```
   "Track the checklist from linkedin-thought-leadership in your response"
   ```

3. **Verification:**
   After each phase:
   ```
   "Verify that we've completed all linkedin-thought-leadership requirements"
   ```
...
You: "I'm going to use the linkedin-thought-leadership skill to approach this systematically.
...
```
"Use brainstorming skill to design this, then linkedin-thought-leadership to implement"
```
...
1. **Start conversations with skill invocation:**
   ```
   "Let's use linkedin-thought-leadership for this task"
   ```
...
3. **Verify completion:**
   ```
   "Did we follow all linkedin-thought-leadership requirements?"
   ```

4. **Reference project knowledge:**
   ```
   "Check linkedin-thought-leadership.md for the exact steps"
   ```
...
- Try: "Check your knowledge files for linkedin-thought-leadership"
...
- **Source:** `superpowers-chatgpt/plus-mode/knowledge-files/content/linkedin-thought-leadership.md`
