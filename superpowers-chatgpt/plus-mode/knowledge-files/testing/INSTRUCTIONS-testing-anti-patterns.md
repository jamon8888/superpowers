# ChatGPT Pro Instructions: testing-anti-patterns
...
2. **Manual Tracking:**
   ...
   ```
   "Track the checklist from testing-anti-patterns in your response"
   ```

3. **Verification:**
   After each phase:
   ```
   "Verify that we've completed all testing-anti-patterns requirements"
   ```
...
You: "I'm going to use the testing-anti-patterns skill to approach this systematically.
...
```
"Use brainstorming skill to design this, then testing-anti-patterns to implement"
```
...
1. **Start conversations with skill invocation:**
   ```
   "Let's use testing-anti-patterns for this task"
   ```
...
3. **Verify completion:**
   ```
   "Did we follow all testing-anti-patterns requirements?"
   ```

4. **Reference project knowledge:**
   ```
   "Check testing-anti-patterns.md for the exact steps"
   ```
...
- Try: "Check your knowledge files for testing-anti-patterns"
...
- **Source:** `superpowers-chatgpt/plus-mode/knowledge-files/testing/testing-anti-patterns.md`
