# ChatGPT Pro Instructions: writing-skills
...
2. **Manual Tracking:**
   ...
   ```
   "Track the checklist from writing-skills in your response"
   ```

3. **Verification:**
   After each phase:
   ```
   "Verify that we've completed all writing-skills requirements"
   ```
...
You: "I'm going to use the writing-skills skill to approach this systematically.
...
```
"Use brainstorming skill to design this, then writing-skills to implement"
```
...
1. **Start conversations with skill invocation:**
   ```
   "Let's use writing-skills for this task"
   ```
...
3. **Verify completion:**
   ```
   "Did we follow all writing-skills requirements?"
   ```

4. **Reference project knowledge:**
   ```
   "Check writing-skills.md for the exact steps"
   ```
...
- Try: "Check your knowledge files for writing-skills"
...
- **Source:** `superpowers-chatgpt/plus-mode/knowledge-files/meta/writing-skills.md`
